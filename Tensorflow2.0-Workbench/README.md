# YoloV3 TensorFlow 2.0 Workbench by Team Digital Roll

This is a modified version of the repo https://github.com/zzh8829/yolov3-tf2
This repo is the basis for a workbench that will aid users in training and validating
their own data and conversting the models produced into Apple CoreML to be used on apple mobile devices
