...
def modify_commands():
    ...
    print("\tCheckpoint Output    ==> " + defaults.CHECKPOINT_VAR + "      ACCEPTS: path to save checkpoints at")
    ...
    print("\tLearning Rate        ==> " + defaults.LEARN_RATE_VAR + "       ACCEPTS: float")
    ...
    print("\tValidate Image Input ==> " + defaults.VALID_IN_VAR + "        ACCEPTS: path to file")
...
def info():
    ...
    print("\t--" + defaults.CHECKPOINT_VAR + ": path that the checkpoint is saved...............................(Default: " + split_path(defaults.DEFAULT_CHECKPOINT_PATH) + ")")
    ...
    print("\t--" + defaults.LEARN_RATE_VAR + ": learning rate of the training....................................(Default: " + split_path(defaults.DEFAULT_LEARN_RATE) + ")")
...
def current_pref():
    ...
    print("\tStarting Checkpoint.... " + preferences.checkpoint_output)
    ...
    print("\tLearning Rate.......... " + str(preferences.learning_rate))
