...
TRAIN_CSV_FILE_LOC = os.getcwd() + "/../data/" + "train_labels.csv"
TRAIN_IMAGES_DIR = os.getcwd() + "/../images/train"

# input test CSV file and test images directory
EVAL_CSV_FILE_LOC = os.getcwd() + "/../data/" + "test_labels.csv"
TEST_IMAGES_DIR = os.getcwd() + "/../images/test"

# training and testing output .tfrecord files
TRAIN_TFRECORD_FILE_LOC = os.getcwd() + "/../data/" + "train.tfrecord"
EVAL_TFRECORD_FILE_LOC = os.getcwd() + "/../data/" + "train.tfrecord"
