...
PIPELINE_CONFIG_PATH = os.getcwd() + "/../training/pre-trained_model/" + "pipeline.config"
...
MODEL_DIR = os.getcwd() + "/../training/" + "pre-trained_model"
...
TRAINING_DATA_DIR = os.getcwd() + "/../training/"
